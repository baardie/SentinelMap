...
namespace SentinelMap.Infrastructure.Migrations
{
    ...
    [Migration("20260324004223_ChangeMapFeatureDetailsToText")]
    partial class ChangeMapFeatureDetailsToText
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SentinelMap.Domain.Entities.CorrelationReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("RuleScores")
                        .HasColumnType("jsonb")
                        .HasColumnName("rule_scores");
                    ...
                    b.ToTable("correlation_reviews", (string)null);
                });
            ...
            modelBuilder.Entity("SentinelMap.Domain.Entities.MapFeature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SentinelMap.Domain.Entities.WebhookDelivery", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SentinelMap.Domain.Entities.WebhookEndpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SentinelMap.Domain.Entities.CorrelationReview", b =>
                {
                    b.HasOne("SentinelMap.Domain.Entities.TrackedEntity", "SourceEntity")
                        .WithMany()
                        .HasForeignKey("SourceEntityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SentinelMap.Domain.Entities.TrackedEntity", "TargetEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("SentinelMap.Domain.Entities.WebhookDelivery", b =>
                {
                    b.HasOne("SentinelMap.Domain.Entities.WebhookEndpoint", "Endpoint")
                        .WithMany()
